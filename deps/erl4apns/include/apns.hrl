...
-record(apns_connection, {apple_host        = "gateway.sandbox.push.apple.com"      :: string(),
                          ...
                          error_fun         = fun(X,Y) -> erlang:display({X,Y}) end :: fun((binary(), erl4apns:status()) -> stop | _),
...
-record(apns_msg, {id = erl4apns:message_id()       :: binary(),
                   expiry = erl4apns:expiry(86400)  :: non_neg_integer(), %% default = 1 day
                   device_token                 :: string(),
                   content_available = false    :: boolean(),
                   alert = none                 :: none | erl4apns:alert(),
                   badge = none                 :: none | integer(),
                   category = none              :: none | string(),
                   sound = none                 :: none | erl4apns:apns_str(),
